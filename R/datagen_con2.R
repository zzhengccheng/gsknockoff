#' This function generate simulated data for gaussian outcomes for K=2
...
#' @param fscale: effect scale multiplier for false signals
#' @return A simulated dataset
#' @export

datagen_con2<-function(n1,n2,p,s0,s1,s2,rho1,rho2,sigma1,sigma2,samesig,scale,fscale=1){
