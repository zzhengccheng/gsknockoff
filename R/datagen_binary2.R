#' This function generate simulated data for binary outcomes for K=2
...
#' @param sigma1 intercept parameter for population 1
#' @param sigma2 intercept parameter for population 2
#' @param samesig whether true signals magnitude the same for all data
#' @return A simulated dataset
#' @export
datagen_binary2<-function(n1,n2,p,s0,s1,s2,rho1,rho2,sigma1,sigma2,samesig,scale){
